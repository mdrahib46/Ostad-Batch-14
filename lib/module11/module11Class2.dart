...
class _Module11class2State extends State<Module11class2> {
  ...
  static const String _email = 'nahid.pidilite@gmail.com';
  static const String _password = '11223344';
  ...
  void _moveToHomeScreen(){
    if(_formKey.currentState!.validate()){
      if(emailController.text.trim() == _email && passwordController.text == _password ){
        if(mounted){
